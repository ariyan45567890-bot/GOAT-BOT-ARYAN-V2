...
module.exports = {
  ...
  onChat: async function ({ api, event, message, usersData }) {
    ...
    "আমাকে না ডেকে মেয়ে হলে বস আরিয়ান এর ইনবক্সে চলে যা 🌚😂 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : 
    ...
    "জান মেয়ে হলে বস আরিয়ান এর ইনবক্সে চলে যাও 😍🫣💕 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : 
    ...
    "ভালোবাসার নামক আবলামি করতে চাইলে বস আরিয়ান এর ইনবক্সে গুতা দিন ~🙊😘🤣 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : ,
